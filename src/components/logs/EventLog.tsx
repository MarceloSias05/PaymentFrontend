                ...
                <div className="flex flex-wrap gap-2">
                    ...
                    <div className="relative">
                        ...
                        <input
                            ...
                            className="pl-9 pr-3 py-1.5 text-sm border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                        />
                    </div>
            ...
            <div className="mt-4 pt-4 border-t border-gray-200">
                <div className="flex flex-wrap gap-4 text-sm text-gray-600">
                    <div className="flex items-center">
                        ...
                        <span>Errores: {logs.filter(l => l.nivel === 'error').length}</span>
                    </div>
                    <div className="flex items-center">
                        <div className="w-2 h-2 bg-yellow-500 rounded-full mr-2"></div>
                        <span>Advertencias: {logs.filter(l => l.nivel === 'warning').length}</span>
                    </div>
                    <div className="flex items-center">
                        <div className="w-2 h-2 bg-green-500 rounded-full mr-2"></div>
                        <span>Éxitos: {logs.filter(l => l.nivel === 'success').length}</span>
                    </div>
                    <div className="flex items-center">
                        <div className="w-2 h-2 bg-blue-500 rounded-full mr-2"></div>
                        <span>Info: {logs.filter(l => l.nivel === 'info').length}</span>
                    </div>
                </div>
            </div>
        </div>
